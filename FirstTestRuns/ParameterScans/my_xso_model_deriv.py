...
model_setup_fsolve = xso.setup(solver='fsolve', model=model,
            time=[0,1],
            input_vars={
                    # State variables
                    'Nutrient':{'value_label':'N','value_init':1.},
...
model_setup = xso.setup(solver='stability', model=model,
            time=[0,1],
            input_vars={
                    # State variables
                    'Nutrient':{'value_label':'N','value_init':1.},
...
model_setup_bifurcate = xso.setup(solver='hybrid_stability', model=model,
            time=[0,1],
            input_vars={
                    # State variables
                    'Nutrient':{'value_label':'N','value_init':1.},
